...
namespace ThunderHenryMod.Scriptables
{
    ...
    class CodeBasedIDRS : ItemDisplayRuleSet
    {
        ...
        // Fill in your item displays below in the 'Item Displays' region.

        // IF YOU NEED MULTIPLE ITEM DISPLAY RULE SETS, you need to create a copy of this script for each survivor. 
        // Edit the item sets however you need.
        // Then in the project explorer folder 'Henry > Definitions' do 'Create > CodeBasedIDRS' (Or whatever you renamed it to).
        // Plug this newly created object into mdlSurvivorName's Character Body 'Item Display Rule Set'.
        // This is ONLY needed if you need multiple rule sets. If you've just got the single survivor, you can edit the item displays in this one.
