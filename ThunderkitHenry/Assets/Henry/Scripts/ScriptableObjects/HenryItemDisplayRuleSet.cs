...
{
    [CreateAssetMenu]
    class HenryItemDisplayRuleSet : CodeBasedIDRS
    {
        // Plug in your Item Displays like you would in the old way of doing things
        // Then you can create an asset based on this script and put it in your Survivor's Body prefab.
        // Everything else should be handled for you.
        public override void SetItemDisplays()
        {
            base.SetItemDisplays();
