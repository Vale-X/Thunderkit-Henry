Shader "stubbed_TextMeshPro/Distance Field" {
	Properties {
			...
			Program "vp" {
				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlatb13 = glstate_matrix_projection[3].w==0.0;
				...
				SubProgram "d3d11 " {
					Keywords { "UNITY_UI_ALPHACLIP" "UNDERLAY_ON" "GLOW_ON" }
					"vs_4_0
				...
				SubProgram "d3d11 " {
					Keywords { "UNITY_UI_CLIP_RECT" "UNDERLAY_ON" "GLOW_ON" }
					"vs_4_0
				...
				SubProgram "d3d11 " {
					Keywords { "UNITY_UI_CLIP_RECT" "UNITY_UI_ALPHACLIP" "UNDERLAY_ON" "GLOW_ON" }
					"vs_4_0
